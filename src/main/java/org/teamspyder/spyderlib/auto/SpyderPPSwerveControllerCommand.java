package org.teamspyder.spyderlib.auto;
...
import org.teamspyder.frc2023.FieldPositions;
...
// This code's originally from PathPlanner. We had to make some modifications in order to make it work with our static origin

/** Custom PathPlanner version of SwerveControllerCommand */
public class SpyderPPSwerveControllerCommand extends CommandBase {
  ...
  private static BiConsumer<Translation2d, Rotation2d> logError =
      SpyderPPSwerveControllerCommand::defaultLogError;
   ...
   */
  public SpyderPPSwerveControllerCommand(
  ...
  public void execute() {
    ...
    if (useAllianceColor && trajectory.fromGUI) {
      desiredState = FieldPositions.flipPathPlannerState(desiredState, Robot.getAlliance());
    }
  ...
  public static void setLoggingCallbacks(
    ...
    SpyderPPSwerveControllerCommand.logActiveTrajectory = logActiveTrajectory;
    SpyderPPSwerveControllerCommand.logTargetPose = logTargetPose;
    SpyderPPSwerveControllerCommand.logSetpoint = logSetpoint;
    SpyderPPSwerveControllerCommand.logError = logError;
  }
}
